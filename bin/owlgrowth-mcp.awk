...
function tools_json() {
    return "{\"tools\":[" \
      ...
      "{\"name\":\"record_adaptation\",\"description\":\"Record scoped action guidance separately from experiences, with supporting experience ids.\",\"inputSchema\":{\"type\":\"object\",\"required\":[\"guidance\",\"scope\"],\"properties\":{\"guidance\":{\"type\":\"string\"},\"scope\":{},\"source_experience_ids\":{\"type\":\"array\"},\"adaptation_id\":{\"type\":\"string\"}}}}," \
